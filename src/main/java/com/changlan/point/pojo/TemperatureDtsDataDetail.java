...
public class TemperatureDtsDataDetail {
//	extends PointInfoDetail
	private TblTemperatureDTSDataEntity temperatureData; //一个监控点的数据
	...
	public TemperatureDtsDataDetail(TblTemperatureDTSDataEntity temperatureData,TblPointsEntity point,TblLinesEntity line) {
//		super(point,line);
		this.point = point;
	...
	public TblTemperatureDTSDataEntity getTemperatureData() {
		return temperatureData;
	}

	public void setTemperatureData(TblTemperatureDTSDataEntity temperatureData) {
		this.temperatureData = temperatureData;
	}
