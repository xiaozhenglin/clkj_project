...
public class AppCountEntity {
	...
	public Integer getCewen_points_total() {
		return cewen_points_total;
	}
	public void setCewen_points_total(Integer cewen_points_total) {
		this.cewen_points_total = cewen_points_total;
	}
	...
	public Integer getLine500_total() {
		return line500_total;
	}
	public void setLine500_total(Integer line500_total) {
		this.line500_total = line500_total;
	}
	...
	public Integer getPaishui_total() {
		return paishui_total;
	}
	public void setPaishui_total(Integer paishui_total) {
		this.paishui_total = paishui_total;
	}
	public Integer getPaifeng_total() {
		return paifeng_total;
	}
	public void setPaifeng_total(Integer paifeng_total) {
		this.paifeng_total = paifeng_total;
	}
