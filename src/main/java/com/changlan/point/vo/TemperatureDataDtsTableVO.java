...
public class TemperatureDataDtsTableVO {
	...
	public TemperatureDataDtsTableVO(Integer indicatorId,List<TemperatureDtsDataDetail> dataDetails) {
	...
	public TemperatureDataDtsTableVO() {
		super();
	}
